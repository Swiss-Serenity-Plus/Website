    ...
    <ServicePageTemplate
      ...
      targetAudience={{
        ...
        profiles: [
          ...
          "PME, TPE et Structures en développement souhaitant renforcer leur organisation, améliorer leur fonctionnement interne, optimiser leur coordination administrative et gagner en efficacité opérationnelle en Suisse romande.",
      ...
      deliverables={{
        ...
        items: [
          ...
          "Soutien dans la gestion administrative, le suivi opérationnel et la coordination des actions en cours",
      ...
      values={{
        ...
        columns: [
          ...
          { title: "Performance", text: "Des solutions pensées pour renforcer l'efficacité opérationnelle, améliorer la circulation des informations et soutenir une organisation plus fluide au quotidien.", image: "https://pub-b61ce5a39cc042cabc94943b3c8f74b4.r2.dev/icons/IconPerformance-removebg-preview.png" },
      ...
      results={{
        ...
        columns: [
          ...
          { icon: Smile, image: "https://pub-b61ce5a39cc042cabc94943b3c8f74b4.r2.dev/blog-covers/1780593218791-8e7464bf-43df-4f6f-9273-ac0c936b3a3a.png", iconScale: 1.7, title: "Une activité plus fluide et plus sereine", text: "Une organisation plus claire et mieux coordonnée pour assurer un suivi administratif fiable, une meilleure continuité des échanges et des actions mieux maîtrisées." },
          { icon: TrendingUp, title: "Développement facilité", text: "Des échanges, des suivis et des priorités mieux structurés pour accompagner plus efficacement l'évolution de vos projets, de votre organisation et de vos besoins opérationnels." },
        ],
      }}
    />
  );
