...
function getCurrentPage(): string {
  return pageNameForPath(window.location.pathname);
}
...
export default function FeedbackWidget() {
  ...
  useEffect(() => {
    ...
    function onClick(e: MouseEvent) {
      ...
      e.stopPropagation();
      overlay.classList.remove("fb-visible");
      setPendingElement(getElementLabel(target, document));
      setPendingElementUrl(getElementUrl(target, window.location));
