      ...
      <div className={styles.inner}>
        <div className={styles.content}>
          ...
          <p className={styles.subtitle}>
            Swiss Serenity Plus® accompagne les Entreprises, les Indépendants, les Institutions, les PPE ainsi que les Particuliers en Valais et en Suisse romande dans leur organisation administrative, leur assistance commerciale, le développement de leur activité, l'amélioration de leur efficacité et la coordination de leurs démarches.
          </p>
