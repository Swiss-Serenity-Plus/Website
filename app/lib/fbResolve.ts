...
export const PLACEHOLDERS: Record<ActionOption | "default", string> = {
  ...
  "Espacement (trop ou pas assez)": "Souhaitez-vous plus ou moins d'espace autour de cet élément ? Précisez où l'espacement vous gêne.",
